...
container.register({
    ...
    accountRepository: awilix.asFunction(require('./data-access-layer-squelize/user_table.js')),
    commentRepository: awilix.asFunction(require('./data-access-layer-squelize/comment_table.js')),
    feedbackRepository: awilix.asFunction(require('./data-access-layer-squelize/feedBack_table.js')),
